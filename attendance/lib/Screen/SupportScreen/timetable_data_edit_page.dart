...
class TimetableDataEditPage extends StatefulWidget {
  static String id = "timetable_data_edit_page";
  final String employeeCode;
  final dynamic data;
  const TimetableDataEditPage(
      {super.key, this.employeeCode = "", this.data = ""});

  @override
  State<TimetableDataEditPage> createState() => _EditDataPageState();
}

class _EditDataPageState extends State<TimetableDataEditPage> {
