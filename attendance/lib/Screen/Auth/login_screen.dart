          ...
          child: Column(
            ...
            children: [
              Row(
                children: [
                  Container(
                    color: isFaculty ? kInactiveTextColor : Colors.transparent,
                    child: TextButton(
                        onPressed: () => {
                              setState(() {
                                isFaculty = true;
                        ...
                        child: Text(
                          "Faculty",
                          style: TextStyle(
                            color: isFaculty ? Colors.white : Colors.black,
                          ),
                        )),
                  ),
                  Container(
              ...
              RawMaterialButton(
                ...
                onPressed: () async {
                  ...
                  try {
                    String url = "";
                    if (isFaculty) {
                      url = '$kBaseLink/api/user/signIn';
                    } else {
                      url = '$kBaseLink/api/admin/signIn';
                    }
                    ...
                    if (response.statusCode == 200) {
                      ...
                      if (!isFaculty) {
                        ...
                        Navigator.popAndPushNamed(context, AdminsHomePage.id);
                        return;
                      }
